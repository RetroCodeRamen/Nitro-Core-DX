...
### 2.5 NEXT_STEPS_PLAN.md (docs/planning/NEXT_STEPS_PLAN.md)
...
- [ ] docs/planning/NEXT_STEPS_PLAN.md status matches reality
...
- [ ] Update README
- [ ] Update CHANGELOG
- [ ] Update docs/planning/NEXT_STEPS_PLAN.md
- [ ] Fix linter errors
- [ ] Verify build
- [ ] Clean up files
- [ ] Stage changes
...
- Document any known issues in docs/planning/NEXT_STEPS_PLAN.md
